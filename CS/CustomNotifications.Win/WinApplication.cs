...
namespace CustomNotifications.Win {
    ...
    public partial class CustomNotificationsWindowsFormsApplication : WinApplication {
        public CustomNotificationsWindowsFormsApplication() {
            InitializeComponent();
        }
        ...
        private void CustomNotificationsWindowsFormsApplication_CustomizeLanguagesList(object sender, CustomizeLanguagesListEventArgs e) {
            string userLanguageName = System.Threading.Thread.CurrentThread.CurrentUICulture.Name;
            if(userLanguageName != "en-US" && e.Languages.IndexOf(userLanguageName) == -1) {
                e.Languages.Add(userLanguageName);
            }
        }
        private void CustomNotificationsWindowsFormsApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
